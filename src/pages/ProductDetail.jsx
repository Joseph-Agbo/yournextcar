...
function ProductDetail() {
  ...
  return (
    <div className="mb-3 pt-2 md:pt-0">
      <div className="flex flex-col gap-4 items-center p-5 md:flex md:justify-around md:flex-row md:gap-5">
        <div className="space-y-3">
          ...
          <img
            ...
            alt=""
            className="width-[80%] h-[50vh] md:h-[70vh]"
          />
        </div>
        <div className="space-y-4 md:flex md:flex-col">
          ...
          <p className="text-blue-950 flex items-center font-bold text-lg">
            <FaNairaSign />
            {specificProduct?.price}
          </p>
          <Link to={`/checkout/${specificProduct?.id}`}>
            <button
              type="button"
              className="border rounded-sm w-full text-md p-2 bg-blue-950 text-white md:p-3 md:w-[80%] md:cursor-pointer md:hover:bg-blue-900 md:transition-all duration-300"
            >
              Buy Now
            </button>
          </Link>
